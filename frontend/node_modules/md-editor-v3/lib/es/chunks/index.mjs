...
const useMarkdownIt = (props, previewOnly) => {
  ...
  const updatedTodo = () => {
    ...
    nextTick(() => {
      replaceMermaid().then(() => {
        var _a;
        zoomMermaid((_a = rootRef.value) == null ? void 0 : _a.querySelectorAll(`#${editorId} .${prefix}-mermaid`));
      });
    });
  };
  const markHtml = () => {
      ...
      if (props.setting.preview) {
        nextTick(() => {
          replaceMermaid().then(() => {
            var _a;
            zoomMermaid(
              (_a = rootRef.value) == null ? void 0 : _a.querySelectorAll(`#${editorId} .${prefix}-mermaid`)
            );
          });
          bus.emit(editorId, CATALOG_CHANGED, headsRef.value);
        });
