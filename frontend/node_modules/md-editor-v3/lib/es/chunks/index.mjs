...
const MermaidPlugin = (md, options) => {
  ...
  md.renderer.rules.fence = (tokens, idx, ops, env, slf) => {
    ...
    if (token.info === "mermaid") {
      ...
      return `<div class="${prefix}-mermaid" ${line !== void 0 ? "data-line=" + line : ""} data-mermaid-theme=${options.themeRef.value} data-code="${code}">${code}</div>`;
    }
  ...
  setup(props) {
    ...
    const updateHtmlContent = (updates, deletes) => {
      ...
      deletes.reverse().forEach((index) => {
        var _a, _b;
        (_b = (_a = htmlContainer.value) == null ? void 0 : _a.children[index]) == null ? void 0 : _b.remove();
      });
      updates.forEach(({
        index,
        newNode
        ...
        var _a, _b;
        const targetNode = (_a = htmlContainer.value) == null ? void 0 : _a.children[index];
        if (targetNode) {
