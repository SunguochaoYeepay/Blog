import { defineComponent, inject, ref, watch, nextTick, createVNode, reactive, shallowRef, provide, computed, onMounted, onBeforeUnmount, Fragment } from "vue";
...
const MdCatalog = /* @__PURE__ */ defineComponent({
  ...
  setup(props2, ctx) {
    ...
    watch([() => props2.syncWith, editorViewRef], () => {
